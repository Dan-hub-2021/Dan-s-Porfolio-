          ...
          <div className="row">
            <div className="col-lg-12" data-aos="fade-up">
              ...
              <div className="resume-item">
                ...
                <p>In the bootcamp we learned both front and back-end development to create webpages how to implment them.</p>
              </div>
              <br/>
              <div className="resume-item">
                ...
                <h5>2017 - 2019</h5>
                <p><em>Westcliff University, Irvine, CA</em></p>
                <p>My MBA foucs was Financial Mangament. In this program we learned more about the business Administration and how to value the most important aspect of the workplace which was the workers and how to lead by example.</p>
              </div>
              <br/>
              <div className="resume-item">
